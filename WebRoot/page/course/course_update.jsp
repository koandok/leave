...
<%  		   
			  ...
			  // String name=(String)session.getAttribute("name");
				...
				String sql = "select * from sys_course where courseID = '"+courseID+"'";
			 //3:查询数据库记录
			 //3.1 加载驱动
...
<div class="panel admin-panel">
  ...
  <div class="body-content" >
    <form action="page/course/action_course_update.jsp" method="post" class="form-x" >  
      ...
      <div class="form-group">
        ...
        <div class="field" align="center">
          <input  type="text" class="input w50" value="<%=courseID%>" name="courseID" data-validate="required:请输入课程编号" />
          <div class="tips"></div>
        </div>
      </div>
