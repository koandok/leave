...
<%  			//设置编码方式
				...
				String sql = "select * from sys_department where depID = '"+depID+"'";
				//2:查询数据库记录
				//2.1 加载驱动
...
<div class="panel admin-panel">
  ...
  <div class="body-content" >
    <form action="page\xueyuan\action_xueyuan_update.jsp" method="post" class="form-x" >  
      ...
      <div class="form-group">
        ...
        <div class="field" align="center">
          <input type="text" class="input w50" value="<%=depName%>" name="depName" data-validate="required:请输入二级学院名称" />
          <div class="tips"></div>
        </div>
      </div>
