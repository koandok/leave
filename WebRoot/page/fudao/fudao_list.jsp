  ...
  <div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="button border-main icon-plus-square-o" href="page\fudao\fudao_add.jsp"> 添加用户</a> </li>
        <li>搜索：</li>
   <li>
       <form method="post" action="page/user/fudao_list.jsp" id="icon-search">
   ...
   <tr>
        ...
        <th>操作</th>
          ...
          String keywords=request.getParameter("keywords");
				...
				sqlBuff.append("select * from sys_instructor where instID like'%"+keywords+"%' or instName like'%"+keywords+"%'");			
            ...
            %>
 			<tr>
				...
				<td>
				<div class="button-group"><a class="button border-main" href="<%=path%>/page/fudao/fudao_update.jsp?instID=<%=instID%>"><span class="icon-edit"></span> 修改</a>  <a class="button border-red" href="<%=path%>\page\fudao\action_fudao_del.jsp?instID=<%=instID%>" ><span class="icon-trash-o"></span> 删除</a> </div>
				</td>
			</tr>
			<%
				}
